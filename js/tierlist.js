...
const TIERLIST_ITEMS = [
  ...
  { id: "melee-brujah",   name: "Brujah Melee",    filter: "melee", clan: "brujah",    icon: null, tier: "a",     subtitle: "Melee", descr: "Strong, consistent damage and reliable timings make Brujah a high-performing melee package even without leaning on clan abilities." },
  ...
  { id: "melee-ventrue",  name: "Ventrue Melee",   filter: "melee", clan: "ventrue",   icon: null, tier: "c",     subtitle: "Melee", descr: "Serviceable but limited melee profile: workable openings and okay consistency, but less overall pressure than top-tier kits." },
